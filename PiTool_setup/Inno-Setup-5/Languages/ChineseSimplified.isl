...
AutoStartPiplay=开机时自动启动Piplay
piplayOculusWarning=检测到您安装了Oculus驱动,为了正常使用Piplay,请先卸载Oculus驱动,或者禁用Oculus服务
piplayJreWarning=检测到您的32位的jre版本高于64位Jre,请先卸载您的32位jre
piplayDllRepair=检测到您的系统运行库有缺失，是否需要修复？
piplayDllRepairDone=修复完成
piplayVideoTypeError=显卡检测失败!
piplayVideoTypeSuccess=显卡检测成功!
piplayVideoTypeInterl=检测到您的计算机只有集成显卡，只支持扩展模式内容，您可以升级您的电脑以获得更多的功能以及更好的体验。
piplayVideoTypeNvidiaLow=检测到您的计算机的NVIDIA显卡版本过低，请先升级显卡驱动！
piplayVideoTypeAmdLow=检测到您的计算机的AMD显卡版本过低，请先升级显卡驱动！
piplayVideoTypeInterlNvidia=检测到您的计算机同时拥有NVIDIA和集成显卡，当前只支持扩展模式内容，您可以进入BIOS，将集成显卡禁用，以获得更多的功能以及更好的体验。
piplayVideoTypeInterlAmd=检测到您的计算机同时拥有AMD和集成显卡，当前只支持扩展模式内容，您可以进入BIOS，将集成显卡禁用，以获得更多的功能以及更好的体验。
piplayVideoTypeInterlAmdNvidia=检测到您的计算机同时拥有NVIDIA和AMD和集成显卡，当前只支持扩展模式内容，您可以进入BIOS，先将集成显卡禁用，并建议使用其中一张AMD或者NVIDIA，以获得更多的功能以及更好的体验。
piplayVideoTypeAmdNvidia=检测到您同时拥有NVIDIA和AMD的显卡，为保证VR内容正常运行，建议使用其中一张。
piplayVideoTypeUnknow=未知显卡，只支持扩展模试内容，您可以升级您的电脑以获得更多的功能以及更好的体验。
piplayVideoTypeNone=未检测到显卡,安装失败！
piplay360CloseMsg=请先关闭360或者QQ管家等杀毒软件，以免安装文件被误删！
